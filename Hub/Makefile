...
all:
	...
	pip3 install astral || echo "Failed to install astral with command: pip3 install astral" > ./Installation/InstallErrors.log
	pip3 install mysql-connector || echo "Failed to install mysql-connector with command: pip3 install mysql-connector" > ./Installation/InstallErrors.log
	...
	# Clean up (setdown?)
	echo "Finished"
	echo ./Installation/InstallErrors.log
