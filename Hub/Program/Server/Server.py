	...
	def __init__(self, System):
		...
		self.add(
		  [
			...
			Route("/api/v1_0/curtains/<int:curtain_id>", "GET", "PATCH"),
			...
			# Route("/api/v1.0/curtains/<string:curtain_name>/event/<string:event_time>", "GET", "PATCH"),
			# Route("/api/v1.0/curtains/<string:curtain_name>/event/<int:event_id>", "GET", "PATCH"),
			# Route("/api/v1.0/curtains/<int:curtain_id>/event/<string:event_time>", "GET", "PATCH"),
			# Route("/api/v1.0/curtains/<int:curtain_id>/event/<int:event_id>", "GET", "PATCH"),

			Route("/api/v1.0/events"),
			Route("/api/v1.0/events/all"),
			Route("/api/v1.0/events/<int:event_id>"),
