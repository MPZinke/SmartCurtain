...
(
	VALUES
	(TIMESTAMP '2021-01-1 01:00:00', 'Home1 Room1'),
	(TIMESTAMP '2021-01-1 02:00:00', 'Home1 Room1'),
	(TIMESTAMP '2021-01-1 03:00:00', 'Home1 Room1')
...
(
	VALUES
	(TIMESTAMP '2021-01-1 01:00:00', 'Home2 Room1'),
	(TIMESTAMP '2021-01-1 02:00:00', 'Home2 Room1'),
	(TIMESTAMP '2021-01-1 03:00:00', 'Home2 Room1')
) AS "T"("time", "Rooms.name")
JOIN "Rooms" ON "T"."Rooms.name" = "Rooms"."name";
...
(
	...
	(TIMESTAMP '2021-01-1 02:00:00', 'Home3 Room1'),
	(TIMESTAMP '2021-01-1 03:00:00', 'Home3 Room1')
) AS "T"("time", "Rooms.name")
JOIN "Rooms" ON "T"."Rooms.name" = "Rooms"."name";
...
(
	VALUES
	(TIMESTAMP '2021-01-1 01:00:00', 'Home4 Room1'),
	(TIMESTAMP '2021-01-1 02:00:00', 'Home4 Room1'),
	(TIMESTAMP '2021-01-1 03:00:00', 'Home4 Room1')
) AS "T"("time", "Rooms.name")
JOIN "Rooms" ON "T"."Rooms.name" = "Rooms"."name";
...
(
	VALUES
	(TIMESTAMP '2021-01-1 01:00:00', 'Home5 Room1'),
	(TIMESTAMP '2021-01-1 02:00:00', 'Home5 Room1'),
	(TIMESTAMP '2021-01-1 03:00:00', 'Home5 Room1')
) AS "T"("time", "Rooms.name")
JOIN "Rooms" ON "T"."Rooms.name" = "Rooms"."name";
...
(
	VALUES
	(TIMESTAMP '2021-01-1 01:00:00', 'Home6 Room1'),
	(TIMESTAMP '2021-01-1 02:00:00', 'Home6 Room1'),
	(TIMESTAMP '2021-01-1 03:00:00', 'Home6 Room1')
) AS "T"("time", "Rooms.name")
JOIN "Rooms" ON "T"."Rooms.name" = "Rooms"."name";
...
-- ———————————————————————————————————— ROOM HAS EVENT,  INSERT HOME @ SAME TIME ———————————————————————————————————— --
...
-- ————————————————————————————————————— ROOM HAS EVENT, INSERT HOME @ NEW TIME ————————————————————————————————————— --
