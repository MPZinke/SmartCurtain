...
-- ——————————————————————————————————— CURTAIN HAS EVENT, INSERT HOME @ SAME TIME ——————————————————————————————————— --
...
(
	VALUES
	(TIMESTAMP '2021-01-1 01:00:00', 'Home1 Room1 Curtain1'),
	(TIMESTAMP '2021-01-1 02:00:00', 'Home1 Room1 Curtain1'),
	(TIMESTAMP '2021-01-1 03:00:00', 'Home1 Room1 Curtain1')
...
-- ——————————————————————————————————— CURTAIN HAS EVENT,  INSERT HOME @ NEW TIME ——————————————————————————————————— --
...
(
	VALUES
	(TIMESTAMP '2021-01-1 01:00:00', 'Home2 Room1 Curtain1'),
	(TIMESTAMP '2021-01-1 02:00:00', 'Home2 Room1 Curtain1'),
	(TIMESTAMP '2021-01-1 03:00:00', 'Home2 Room1 Curtain1')
) AS "T"("time", "Curtains.name")
JOIN "Curtains" ON "T"."Curtains.name" = "Curtains"."name";
...
(
	VALUES
	(TIMESTAMP '2021-01-1 04:00:00', 'Home2 Room1')
) AS "T"("time", "Homes.name")
JOIN "Homes" ON "T"."Homes.name" = "Homes"."name";
...
(
	VALUES
	(TIMESTAMP '2021-01-1 01:00:00', 'Home3 Room1 Curtain1'),
	(TIMESTAMP '2021-01-1 02:00:00', 'Home3 Room1 Curtain1'),
	(TIMESTAMP '2021-01-1 03:00:00', 'Home3 Room1 Curtain1')
) AS "T"("time", "Curtains.name")
JOIN "Curtains" ON "T"."Curtains.name" = "Curtains"."name";
...
(
	VALUES
	(TIMESTAMP '2021-01-1 01:00:00', 'Home4 Room1 Curtain1'),
	(TIMESTAMP '2021-01-1 02:00:00', 'Home4 Room1 Curtain1'),
	(TIMESTAMP '2021-01-1 03:00:00', 'Home4 Room1 Curtain1')
) AS "T"("time", "Curtains.name")
JOIN "Curtains" ON "T"."Curtains.name" = "Curtains"."name";
...
(
	...
	(TIMESTAMP '2021-01-1 02:00:00', 'Home5 Room1 Curtain1'),
	(TIMESTAMP '2021-01-1 03:00:00', 'Home5 Room1 Curtain1')
) AS "T"("time", "Curtains.name")
JOIN "Curtains" ON "T"."Curtains.name" = "Curtains"."name";
...
(
	VALUES
	(TIMESTAMP '2021-01-1 01:00:00', 'Home6 Room1 Curtain1'),
	(TIMESTAMP '2021-01-1 02:00:00', 'Home6 Room1 Curtain1'),
	(TIMESTAMP '2021-01-1 03:00:00', 'Home6 Room1 Curtain1')
) AS "T"("time", "Curtains.name")
JOIN "Curtains" ON "T"."Curtains.name" = "Curtains"."name";
